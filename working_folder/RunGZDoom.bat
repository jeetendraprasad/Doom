...
gzdoom -nosound -nomusic +vid_fps 1 -config %work_folder%\gzdoom.ini -file "DoomHDv03.pk3"
@REM -file JP_HUD_mod_friendly.pk3 -file "SuperGun.zip" -file 3D_Models.pk3
